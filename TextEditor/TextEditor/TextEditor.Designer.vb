...
Partial Class frmTextEditor
    ...
    Private Sub InitializeComponent()
        ...
        Me.mnuStrip.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.mnuFile, Me.mnuEdit, Me.mnuHelp})
        Me.mnuStrip.Location = New System.Drawing.Point(0, 0)
        Me.mnuStrip.Name = "mnuStrip"
        Me.mnuStrip.Size = New System.Drawing.Size(800, 28)
        Me.mnuStrip.TabIndex = 0
        Me.mnuStrip.Text = "Menu"
        '
        'mnuFile
        '
        ...
        Me.mnuFile.ToolTipText = "Basic File Operations"
        '
        'mnuFileNew
        '
        ...
        Me.mnuFileNew.ToolTipText = "Click to create a new File."
        '
        'mnuFileOpen
        '
        ...
        Me.mnuFileOpen.ToolTipText = "Click to open a file from computer"
        '
        'mnuFileSave
        '
        ...
        Me.mnuFileSave.ToolTipText = "Click to save the current file"
        '
        'mnuFileSaveAs
        '
        ...
        Me.mnuFileSaveAs.ToolTipText = "Click to save the current file."
        '
        'mnuFileClose
        '
        ...
        Me.mnuFileClose.ToolTipText = "Clcik to close the current file."
        '
        'mnuFileExit
        '
        ...
        Me.mnuFileExit.ToolTipText = "Click to exit the editor."
        '
        'mnuEdit
        '
        ...
        Me.mnuEdit.ToolTipText = "Clcik to see edit options."
        '
        'mnuEditCopy
        '
        ...
        Me.mnuEditCopy.ToolTipText = "Click to copy the selected text."
        '
        'mnuEditCut
        '
        ...
        Me.mnuEditCut.ToolTipText = "Clcik to copy the selected text and delete it from text editor."
        '
        'mnuEditPaste
        '
        ...
        Me.mnuEditPaste.ToolTipText = "Click to paste the text in clipboard."
        '
        'mnuHelp
        '
        ...
        Me.mnuHelp.ToolTipText = "Click to get help options."
        '
        'mnuHelpAbout
        '
        ...
        Me.mnuHelpAbout.ToolTipText = "Click to see info about the editor."
        '
        'txtText
        '
        Me.txtText.Dock = System.Windows.Forms.DockStyle.Fill
        Me.txtText.Location = New System.Drawing.Point(0, 28)
        Me.txtText.Multiline = True
        Me.txtText.Name = "txtText"
        Me.txtText.Size = New System.Drawing.Size(800, 422)
